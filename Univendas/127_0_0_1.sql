...
--
-- Host: 127.0.0.1
-- Generation Time: 13-Jan-2017 às 18:35
...
('root', '[{"db":"venda","table":"itens_de_venda"},{"db":"venda","table":"prevenda"},{"db":"venda","table":"usuario"},{"db":"venda","table":"venda"},{"db":"venda","table":"loja"},{"db":"mydb","table":"loja"},{"db":"mydb","table":"venda"},{"db":"mydb","table":"usuario"},{"db":"vendas","table":"itens_de_venda"},{"db":"vendas","table":"venda"}]');
...
('root', '2016-12-30 11:23:07', '{"lang":"pt","collation_connection":"utf8mb4_unicode_ci","ThemeDefault":"pmahomme"}');
...
ALTER TABLE `itens_de_venda`
  ADD PRIMARY KEY (`ID_ITENS_DE_VENDA`,`LOJA_ID_LOJA`,`VENDA_ID_VENDA`),
